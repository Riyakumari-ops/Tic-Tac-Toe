...
lblPlayerX =Label(RightFrame1, font=('arial',50,'bold'), text="Player X", padx=2, pady=2, bg='Cadet Blue')
...
lblPlayerO =Label(RightFrame1, font=('arial',50,'bold'), text="Player O ", padx=2, pady=2, bg='Cadet Blue')
